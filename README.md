...
1. In your own words, define closure (1-2 sentences).
   Closure is what allows functions to access variables defined outside of the function.
...
name is defined outside the function when the user passes the argument into 'name'. The function is able to access it because functions can go above their scope.

b. Compare and contrast calling `dansRoll` the first and second time. What is always the same? What could change?

newRoll can change. It will not always be the same.
