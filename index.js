...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
   The main difference is the scope of the count variable for each function. In counter2 the count has global scope. This means other functions can access it. 
  2. Which of the two uses a closure? How can you tell?
  counter2 uses a closure. The line const counter1 = counterMaker();
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  counter1 is the better block of code because programmers should avoid global variables in large programs or they may be accidentally reassigned. counter1 is better in all situations, except when the count variable needs to be accessed in a later function. */
